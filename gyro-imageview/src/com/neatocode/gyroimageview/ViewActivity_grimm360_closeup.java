 ...
 *
 */
public class ViewActivity_grimm360_closeup extends Activity implements FilteredOrientationTracker.Listener {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	ScreenOn.run(this);
       	...
       	setContentView(R.layout.view_activity_grimm360_closeup);
	...
	private void animateTo(final float animationOffsetX, final float animationOffsetY) {
		...
		//final int topBoundary = maxHeight; //(maxHeight / 2);
		//final int bottomBoundary = 0;//(-maxHeight / 2) + image.getDisplayHeight();
